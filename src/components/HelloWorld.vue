  ...
  data() {
    return {
      ...
      newTudu: [
        {
            id: 1 as Number,
            text: "Learn Vue" as string,
            text1: "Learn Vue 3" as string
          },
          {
            id: 2 as Number,
            text: "Learn React" as string,
            text1: "Learn React 17" as string
          },
          {
            id: 3 as Number,
            text: "Learn Angular" as string,
            text1: "Learn Angular 12" as string
          }
      ],
      text: "" as string,
      text1: "" as string,
...
<template>
  <div class="container mx-auto p-6">
    <h1 @click="AddTodo" class="cursor-pointer text-blue-600 font-semibold text-xl h1class text-center">Add Todo</h1>
    <div v-if="showModal" class="fixed z-10 inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div class="bg-white p-6 rounded shadow-lg">
        <form @submit.prevent="submit">
          ...
          <div class="flex justify-end">
            ...
            <button type="button" @click="closeModal" class="bg-gray-300 text-gray-700 px-4 py-2 rounded ml-2">Close</button>
          </div>
        </form>
      </div>
    </div>
